...
from .views import (
    ...
    view_transaction,long_poll_messages, check_new_messages, send_message, reply_view,
    mark_messages_read, check_typing_status, upload_chat_file, delete_message, settlement_calculator,
    settlement_statement, settlement_statement_pdf,
)
...
urlpatterns = [
    ...
    path("settlement-statement-pdf/", settlement_statement_pdf, name="settlement_statement_pdf"),
